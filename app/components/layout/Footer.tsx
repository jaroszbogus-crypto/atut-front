...
export default function Footer() {
  return (
    <footer
      className="bg-gray-950 pt-20 pb-10 text-white font-sans border-t-4 border-red-600"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-mono">
            <li className="flex justify-between border-b border-white/5 pb-2">
              ...
              <span className="text-red-400">07:00 - 15:30</span>
            </li>
            <li className="flex justify-between border-b border-white/5 pb-2">
              <span>Sobota:</span>{" "}
        ...
        <div className="bg-white/5 p-8 border border-white/10">
          ...
          <p className="text-gray-400 text-sm mb-8 leading-relaxed">
            Nasi inżynierowie są gotowi do analizy Twojego parku maszynowego.
          </p>
          <button className="w-full bg-red-600 py-4 font-bold text-xs uppercase tracking-widest hover:bg-white hover:text-gray-950 transition-all">
            Zapytaj o termin //
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 border-t border-white/10 flex flex-col md:row justify-between items-center text-[10px] text-gray-500 uppercase tracking-widest gap-4">
        <p>© PPHU ATUT SP. Z O.O. WSZELKIE PRAWA ZASTRZEŻONE.</p>
